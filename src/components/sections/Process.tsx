  ...
  const processSteps = [
    {
      ...
      shadowColor: 'shadow-[6px_6px_0px_0px_rgba(231,31,92,1)]', 
      icon: (
    ...
    },
    {
      ...
      shadowColor: 'shadow-[6px_6px_0px_0px_rgba(249,167,30,1)]', 
      icon: (
        <svg className="w-8 h-8 text-zinc-900" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      shadowColor: 'shadow-[6px_6px_0px_0px_rgba(24,24,27,1)]', 
      icon: (
        <svg className="w-8 h-8 text-zinc-900" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  ...
  return (
    <section id="process" className="py-24 px-6 md:px-12 lg:px-24 bg-primary border-b-[6px] border-zinc-900 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center lg:items-start">
        ...
        <div className="w-full lg:w-1/3 space-y-6 text-center lg:text-left relative lg:sticky lg:top-32">
        ...
        <div className="w-full lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-y-12 gap-x-8 pr-4 sm:pr-8 md:pr-0">
          {processSteps.map((step, index) => (
            ...
            >
              ...
              <div className="absolute -top-6 -right-3 md:-top-5 md:-right-5 w-12 h-12 bg-accent-yellow border-4 border-zinc-900 rounded-full flex items-center justify-center font-extrabold text-xl text-zinc-900 z-10">
                {index + 1}
              </div>
