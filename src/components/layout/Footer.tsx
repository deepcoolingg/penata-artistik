...
const Footer = () => {
  return (
    // Pake id="contact" biar menu Contact di Navbar ngarah ke sini
    <footer id="contact" className="bg-zinc-900 text-primary flex flex-col overflow-hidden">
      
      {/* SECTION ATAS: Call to Action (CTA) */}
      ...
      {/* SECTION TENGAH: Socials & Address (Dibatasi garis estetik) */}
      <div className="border-t-[4px] border-accent-pink">
        <div className="max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-24 py-12 flex flex-col md:flex-row justify-between gap-12 lg:gap-24">
          ...
          {/* Kiri: Social Icons & Copyright */}
          <div className="flex flex-col justify-between space-y-8">
            {/* Social Icons (Pakai SVG biar ga usah install package) */}
            <div className="flex items-center gap-6">
              
              {/* Instagram - DITAMBAHIN TARGET BLANK */}
              <a 
              ...
              {/* LinkedIn - DITAMBAHIN TARGET BLANK */}
              <a 
      ...
      {/* SECTION BAWAH: Huge Typography Kepotong */}
